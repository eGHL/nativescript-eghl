...
exports.onSaleButtonPressed = function (args) {
    if (args.object.ios) {
        ...
        var paymentID = eghl.generateId("SIT");
        var payment = new com.eghl.sdk.params.PaymentParams();
        ...
        //ExecutePayment
        eghl.executePayment(paymentParams,activity);
        ...
        app.android.on("activityResult", function (args) {
            ...
            if (requestCode == eghl.REQUEST_PAYMENT) {
                switch (resultCode) {
                    ...
                    console.log("status" + eghl.TXN_STATUS);
                    console.log("message" + eghl.TXN_MESSAGE);
                    console.log("raw" + eghl.TTXN_RAW_RESPONSE);
                    break;
